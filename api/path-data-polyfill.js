...
if (!SVGPathElement.prototype.getPathData || !SVGPathElement.prototype.setPathData) {
  (function() {
    ...
    SVGPathElement.prototype.addBehaviour = function(pathData) {
      //Add functionalities to be compatible with SVGPAthSegList behaviour
      for (var id in pathData){
        var pathSeg = pathData[id];
      ...
      pathData.removeItem = function(index){
        pathData.numberOfItems -= 1;
        return pathData.splice(index, 1);
      };
      pathData.insertItemBefore = function(item, index){
        pathData.numberOfItems += 1;
    ...
    SVGPathElement.prototype.getPathData = function(options) {
      if (options && options.normalize) {
        if (this[$cachedNormalizedPathData]) {
          var data = clonePathData(this[$cachedNormalizedPathData]);
          this.addBehaviour(data);
          return data;
        }
        else {
          var pathData;
          ...
          this.addBehaviour(normalizedPathData);
          return normalizedPathData;
        }
      }
      else {
        if (this[$cachedPathData]) {
          var data = clonePathData(this[$cachedPathData]);
          this.addBehaviour(data);
          return data;
        }
        else {
