         ...
         */
                    ...
                    , addPane = function (pane, force) {
                        ...
                        if (o.showOverflowOnHover)
                            $P.on('mouseenter mouseleave',allowOverflow, resetOverflow);
                    ...
                    , initHandles = function (panes) {
                        ...
                        $.each(panes, function (i, pane) {
                            ...
                            $R // if paneSelector is an ID, then create a matching ID for the resizer, eg: "#paneLeft" => "paneLeft-resizer"
                                ...
                                .on('mouseenter mouseleave',addHover, removeHover) // ALWAYS add hover-classes, even if resizing is not enabled - handle with CSS instead
                                .on('mouseenter mouseleave',onResizerEnter, onResizerLeave) // ALWAYS NEED resizer.mouseleave to balance toggler.mouseenter
                            ...
                            if ($T) {
                                $T // if paneSelector is an ID, then create a matching ID for the resizer, eg: "#paneLeft" => "#paneLeft-toggler"
                                    ...
                                    .on('mouseenter mouseleave',addHover, removeHover) // ALWAYS add hover-classes, even if toggling is not enabled - handle with CSS instead
