...
Selector.corners = {
	'nw': function(x, y, w, h){return {x:x+w, y:y};},
	'n' : function(x, y, w, h){return {x:x+w/2, y:y};},
	'ne': function(x, y, w, h){return {x:x, y:y};},
	'e' : function(x, y, w, h){return {x:x, y:y+h/2};},
	'se': function(x, y, w, h){return {x:x, y:y+h};},
	's' : function(x, y, w, h){return {x:x+w/2, y:y+h};},
	'sw': function(x, y, w, h){return {x:x+w, y:y+h};},
	'w' : function(x, y, w, h){return {x:x+w, y:y+h/2};},
}
