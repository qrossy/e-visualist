...
}E._innerDiv.appendChild(this._highlightDiv);
}};
...
var K=J.trackOffset+B*J.trackIncrement+10;
...
this.ether={backgroundColors:[],
highlightOpacity:50,
interval:{line:{show:true,opacity:25},
weekend:{opacity:30},
...
bubble:{width:250,maxHeight:0,titleStyler:function(A){A.className="timeline-event-bubble-title";
