...
var i = -1;
SimileAjax.DateTime.MILLISECOND=(i +=1);
SimileAjax.DateTime.SECOND=(i +=1);
SimileAjax.DateTime.MINUTE=(i +=1);
SimileAjax.DateTime.HOUR=(i +=1);
SimileAjax.DateTime.TRIHOUR=(i +=1);
SimileAjax.DateTime.QUARTERDAY=(i +=1);
SimileAjax.DateTime.DAY=(i +=1);
SimileAjax.DateTime.WEEK=(i +=1);
SimileAjax.DateTime.MONTH=(i +=1);
SimileAjax.DateTime.YEAR=(i +=1);
SimileAjax.DateTime.DECADE=(i +=1);
SimileAjax.DateTime.CENTURY=(i +=1);
SimileAjax.DateTime.MILLENNIUM=(i +=1);
...
A[B.TRIHOUR]=A[B.HOUR]*3;
A[B.QUARTERDAY]=A[B.TRIHOUR]*2;
A[B.DAY]=A[B.QUARTERDAY]*4;
A[B.WEEK]=A[B.DAY]*7;
...
break;
case SimileAjax.DateTime.TRIHOUR:C.setTime(C.getTime()+SimileAjax.DateTime.gregorianUnitLengths[SimileAjax.DateTime.TRIHOUR]);
break;
case SimileAjax.DateTime.QUARTERDAY:C.setTime(C.getTime()+SimileAjax.DateTime.gregorianUnitLengths[SimileAjax.DateTime.QUARTERDAY]);
break;
